...
Помимо самого совпадения с регулярным выражением будем хранить позицию в области поиска, где нашлось данное совпадение, чтобы после найти первое совпадение.
